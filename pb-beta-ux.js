...
(function (global) {
  ...
  function mapBetRejectMessage(code, userMessage) {
    ...
    var map = {
      ...
      line_changed: 'The line moved — confirm the new wager before placing.',
      odds_changed: 'Odds moved — confirm the new price before placing.',
      ...
      odds_stale: 'Current odds unavailable for this selection — please try again.',
